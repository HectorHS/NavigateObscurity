<template>
    ...
    <h1>US cohort - variable comparison</h1>
    <div class="dashboard-text">
        We surveyed 921 US based participants every one or two months for two years. During that time they answered about a thousand unique questions for us. Use the dashboard below to see how their responses correlate.
    </div>
                ...
                <div class="dashboard-container-vertical dashboard-level-1">
                    <div class="dashboard-container-horizontal dashboard-side-60">
                        <div style="height: inherit;">
                            <div class="cclab-stats-container1">
                                ...
                                <div class="cclab-stats-container2">
                                    <div class="dash-stat-box dash-stat-box-3">
                                        <div class="cclab-stat-label-container">
                                            <div class="cclab-stat-label">Infected contacts - avg</div>
                                            <div class="cclab-stat-sublabel">({{ selectedDate }})</div>
                                        </div>
                                    ...
                                    <div class="dash-stat-box dash-stat-box-4">
                                        <div class="cclab-stat-label-container">
                                            <div class="cclab-stat-label">In high risk occupation</div>
                                            <div class="cclab-stat-sublabel">({{ selectedDate }})</div>
                                        </div>
                                        <div class="cclab-stat-value">{{ stats.risk }}</div>
                                    </div>
                                </div>
                            </div>
                            <div v-if="validCombo" class="chart-inset h-[400px] !mb-[15px]">
                            ...
                            <div v-if="validCombo" class="chart-inset h-[438px]">
...
<script lang="ts">
  ...
  export default defineComponent ({
    ...
    setup() {
      const usComnparisonStore = useUsComparisonStore()
      return { usComnparisonStore }
    },
    data: () => ({
search: ''
    }),
    ...
    computed: {
        ...mapState(useUsComparisonStore , ['descriptions_lookup', 'stats','validCombo','pie1Options','pie2Options','heatmapOptions',
            'all_variables','all_dates','availableVar2','barOptions','lineOptions']),
        ...mapWritableState(useUsComparisonStore, ['selectedVar1','selectedVar2','selectedDate']),
    },
    mounted () {
        this.usComnparisonStore.loadData();
    }
  })
