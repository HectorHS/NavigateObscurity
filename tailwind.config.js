  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'demo-area': "url('/images/demo/area.jpg')",
        'demo-bars': "url('/images/demo/bars.jpg')",
        'demo-bars-stacked': "url('/images/demo/bars-stacked.jpg')",
        'demo-bubbles': "url('/images/demo/bubbles.jpg')",
        'demo-columns': "url('/images/demo/columns.jpg')",
        'demo-columns-line': "url('/images/demo/columns-line.jpg')",
        'demo-columns-lines': "url('/images/demo/columns-lines.jpg')",
        'demo-columns-stacked': "url('/images/demo/columns-stacked.jpg')",
        'demo-map-light': "url('/images/demo/map-light.jpg')",
        'demo-pyramid': "url('/images/demo/pyramid.jpg')",
        'demo-sunburst': "url('/images/demo/sunburst.jpg')",
        'demo-treemap': "url('/images/demo/treemap.jpg')",
        'demo-treemap-light': "url('/images/demo/treemap-light.jpg')",
        'demo-wheel': "url('/images/demo/wheel.jpg')",
        'demo-area-light': "url('/images/demo/area-light.jpg')",
        'demo-sunburst-light': "url('/images/demo/sunburst-light.jpg')",
      },
      fontSize: {
